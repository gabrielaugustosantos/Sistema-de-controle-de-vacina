...
public class VacinacaoSteps {
    ...
    public void registreiADoseAplicadaEm(int doseAtual, String dataAplicacao) {
        // Usando o construtor correto e o usuário que já foi criado no @Dado
        registroAtual = new RegistroVacina(usuario, vacina, doseAtual, DoseStatus.APLICADA);
    ...
    public void oStatusDaProximaDoseDeveSer(String statusEsperado) {
        assertEquals(statusEsperado, proximaDose.getDoseStatus().name());
    }
